...
<body style="background: lightgray">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12">
                    <div>
                        <h3 class="text-center my-4">Daftar Peminjam</h3>      
                        <hr>
                    </div>
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            <a href="{{ route('peminjam.create') }}" class="btn btn-md btn-success mb-3">Tambah Peminjam</a>
                                  ...
                                  <tr>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('peminjam.destroy', $peminjam->id) }}" method="POST">
                                                <a href="{{ route('peminjam.edit', $peminjam->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                @csrf
                                                @method('DELETE')
